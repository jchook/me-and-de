...
# How much SHOULD Crypto Currencies be worth?

Perhaps tragically, Bitcoin suffers a dire and strange paradox. Its perceived value rests on its usefulness as a currency, which in turn rests on its stability. However, its stability rests back on its perceived value, forming a nearly perfect feedback loop of either self-inflation or -deflation.
...
- **It's standard.** Official holdings and investments account for 32% of mined gold, and it has been used as currency for millennia.

Many experts agree that Bitcoin does **not** have intrinsic value. Well, guess what. Neither does fiat money such as the US Dollar or Chinese Yen.

The first fiat money emerged in China 1000 years ago. Think about that. In the meter-long history of money, fiat money only represents the last centimeter. We have living trees five times older than the concept of fiat money. Given how recently it emerged, we might even expect some major leaps or advancements in this ubiquitous and potent social technology.

Fiat currency has value purely by declaration. "This has value." Done. So, ostensibly, we could call Bitcoin the first truly democratic fiat currency. It carries the exact value the market says it does.
...
Democracy essentially means "mob rule", and has endured a long history of abhorrence and avoidance, even by the framers of the US Constitution.

The reasoning seems quite simple, even without the help of Montesquieu or Madison: None of us is as dumb as all of us.

About half of everyone (if not more) is dumber than the average person. Despite the populararity of its glittering generality, no one wants everyone to make decisions about their future.
